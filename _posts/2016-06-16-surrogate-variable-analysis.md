...
The benefits of surrogate variable analysis, evaluated using a large data set, were equivocal. However, the above analysis included only a few human clinical studies, where expression heterogeneity is potentially more common. For this reason, I plan to keep sva as the default for crossmeta.
